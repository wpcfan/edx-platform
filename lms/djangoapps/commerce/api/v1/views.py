...
from lms.djangoapps.commerce.api.v1.permissions import ApiKeyOrModelPermission, IsAuthenticatedOrActivationOverridden
from lms.djangoapps.commerce.api.v1.serializers import CourseSerializer
